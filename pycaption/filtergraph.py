...
class FiltergraphWriter(SubtitleImageBasedWriter):
    ...
    def write(
        ...
        - render.sh: Shell script to run FFmpeg
        ...
        :param output_file: Output filename (used in render script)
        :param image_dir: Directory name for images in the ZIP
        ...
        with tempfile.TemporaryDirectory() as tmpDir:
            ...
            for i in range(1, len(caps_final) + 1):
                filter_parts.append(
                    f"movie={image_dir}/subtitle{i:04d}.png,format=yuva420p[s{i}]"
                )
...
# Generated by pycaption FiltergraphWriter
# Creates a transparent WebM with subtitle overlays
...
'''
            ...
            with zipfile.ZipFile(buf, 'w', zipfile.ZIP_DEFLATED) as zf:
                ...
                for i in range(1, len(caps_final) + 1):
                    ...
                    zf.write(img_path, f'{image_dir}/subtitle{i:04d}.png')

                # Add filtergraph
                zf.writestr('filtergraph.txt', filtergraph)

                # Add render script
                zf.writestr('render.sh', render_script)
